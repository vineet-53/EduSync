...
export default function EnrolledCourse({ course }) {
    return (
        <div className=' w-full flex items-center flex-col md:flex-row '>
            <div className='max-sm:w-11/12 h-full grid md:flex md:gap-2 grid-cols-1 max-sm:gap-2 bg-custom-secondary bg-opacity-30 px-3 py-4 rounded-md hover:scale-105 transition-all duration-700 '>
                ...
                <div className=' flex items-center py-2 text-yellow-100 font-bold text-xl'>
                    ₹{course.price}
                </div>
