...
import { removeProfilePicture } from '../../../../services/operations/profile';
import { ActiveIconButtonStyle, EditIconButtonStyle } from '../../../../styles/constantsStyles';
        ...
        <div className='flex items-center gap-2' >
            ...
            <div className='flex flex-col gap-1'>
                ...
                <div className='flex gap-2'>
                    ...
                    <button className='text-pink-25 bg-pink-600 px-3 h-max py-2 rounded-md' onClick={handleRemoveProfilePicture}>
                        Remove
                    </button>
                </div>
            </div>
